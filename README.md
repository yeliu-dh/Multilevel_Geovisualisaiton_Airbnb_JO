...
L'objectif est d'analyser les **comportements stratégique des hôtes**, que ce soit la participation au marché ou l'ajustement des stratégies de communication, et la manière dont un événement majeur influence **l'offre et la demande** dans le contexte urbain parisien.
...
- Hôtes qui reviennent en juin (n’existe pas dans les données de mars),
- Hôtes qui réouvrent leur disponibilité pour JO (disponibilité_90=0 en mars);
b) Au niveau de présentation de soi : 
- Hôtes qui modifient sa description ou /et la photo personnelle(s)
...
## Résultats de visualisation :output_map1
## Analyses :
-**tendance globale**:
- Densité des hôtes : Augmentation forte en juin, surtout 11e, 15e, 17e, 18e arrondissements, proches aux sites olympiques, réduction en septembre.
- Prix moyenne : la hausse n'est pas généralisé, elle dépasse 100 euros dans les dans 7e et 16e arronds.
- Disponibilité 90:  augmente de 10 jours environ pendant JO, elle 
se maintient et progresse après JO

- **hôtes en changement**:
- Changements: jusqu'à 50% environ dans tous les arronds, surtout aux arrondissements extérieurs de Paris, du 11e au 20e arrondissements.
- Entrants récents vs adaptation de stratégies communicatives :
...
• 15e, 16e arrondissements sont des zones mixtes : beaucoup de nouveaux entrants et nouvelles images de soi.


- **JO marketing**:
- Les JO comme un argument de marketing devient plus fréquent 
en juin, surtout dans les arrondissements proches aux sites 
olympiques, mais la proportion globale reste relativement faible (10%)
